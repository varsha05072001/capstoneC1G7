...
import { CardinascComponent } from './pages/cardinasc/cardinasc.component';
import { CardindescComponent } from './pages/cardindesc/cardindesc.component';
...
const routes: Routes = [
    ...
    {path:'productbyasc',component:CardinascComponent},
    {path:'productbydesc',component:CardindescComponent},
